<?php
/**
 * File: quickpayalipaysubs.php
 * Functionality: QuickPay-支付宝-订购版
 * Author: Cheeli
 * WebSite: http://www.cheeli.com.cn
 * Date: 2020-06-11
 */
namespace Pay\quickpayalipaysubs;
use \Pay\notify;

class quickpayalipaysubs
{
 	private $paymethod = "quickpayalipaysubs";
