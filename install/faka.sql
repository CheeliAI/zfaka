...
INSERT INTO  `t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (1, '有赞接口', '微信', '/res/images/pay/yzpay.jpg', 'yzpay', 'RSA2', '', '', '', '', '', '', 0, 0);
INSERT INTO  `t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (2, 'PAYPAL', 'PAYPAL', '/res/images/pay/paypal.jpg', 'paypal', 'RSA2', '', '', '', '', 'live', '7', 0, 0);
INSERT INTO  `t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (3, 'QuickPay-支付宝订购版', '支付宝', '/res/images/pay/alipay.jpg', 'quickpayalipaysubs', 'RSA2', '99lsUeiaI1j22', 'fU5U5CaNnhF2af', '', '', 'https://open.baolai.la/gateway/partner/pay/tradeprecreate', '迈步', 180, 1);
INSERT INTO  `t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (4, 'QuickPay-微信便捷版', '微信', '/res/images/pay/weixin.jpg', 'quickpayweixinagent', 'RSA2', '99lsUeiaI1j22', 'fU5U5CaNnhF2af', ' ', '', 'https://open.baolai.la/gateway/partner/pay/tradeprecreate', '', 0, 1);

INSERT INTO `faka`.`t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (5, 'QuickPay-支付宝便捷版', '支付宝', '/res/images/pay/alipay.jpg', 'quickpayalipayagent', 'RSA2', '99lsUeiaI1j22', 'fU5U5CaNnhF2af', '', '', 'https://open.baolai.la/gateway/partner/pay/tradeprecreate', '', 300, 0);
INSERT INTO `faka`.`t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (6, 'QuickPay-微信签约版', '微信', '/res/images/pay/weixin.jpg', 'quickpayweixinsigning', 'RSA2', '99lsUeiaI1j22', 'fU5U5CaNnhF2af', '', '', 'https://open.baolai.la/gateway/partner/pay/tradeprecreate', '1587507961', 300, 1);
INSERT INTO `faka`.`t_payment`(`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES (7, 'QuickPay-支付宝签约版', '支付宝', '/res/images/pay/alipay.jpg', 'quickpayalipaysigning', 'RSA2', '99lsUeiaI1j22', 'fU5U5CaNnhF2af', '', '', 'https://open.baolai.la/gateway/partner/pay/tradeprecreate', '2088701568962424', 300, 1);
