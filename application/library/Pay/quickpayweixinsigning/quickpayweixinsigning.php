<?php
/**
 * File: quickpayweixinsigning.php
 * Functionality: QuickPay-微信-签约版
 * Author: Cheeli
 * WebSite: http://www.cheeli.com.cn
 * Date: 2020-06-11
 */
namespace Pay\quickpayweixinsigning;
use \Pay\notify;

class quickpayweixinsigning
{
 	private $paymethod = "quickpayweixinsigning";
