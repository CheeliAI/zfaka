<?php
/**
 * File: quickpayalipaysigning.php
 * Functionality: QuickPay-支付宝-签约版
 * Author: Cheeli
 * WebSite: http://www.cheeli.com.cn
 * Date: 2020-06-11
 */
namespace Pay\quickpayalipaysigning;
use \Pay\notify;

class quickpayalipaysigning
{
 	private $paymethod = "quickpayalipaysigning";
	...
	public function pay($payconfig,$params)
	{
		...
		$config = array(
			...
			"agent_channel" =>  '4'  ,  //  4：支付宝商家签约版 
			"mch_id" =>  $payconfig['configure4'] ,   
		);
